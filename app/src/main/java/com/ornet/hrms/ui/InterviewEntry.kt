...
import com.ornet.hrms.databinding.ActivityInterviewEntryBinding

class InterviewEntry : AppCompatActivity() {
    lateinit var binding: ActivityInterviewEntryBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this, R.layout.activity_interview_entry)
        toolbarHandle()
    }
    fun toolbarHandle(){
